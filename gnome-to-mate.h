...
#define gmenu_tree_get_canonical_menu_path matemenu_tree_get_canonical_menu_path
...
#define GMENU_TREE_FLAGS_INCLUDE_EXCLUDED  MATEMENU_TREE_FLAGS_INCLUDE_EXCLUDED
#define GMENU_TREE_FLAGS_INCLUDE_NODISPLAY MATEMENU_TREE_FLAGS_INCLUDE_NODISPLAY
#define GMENU_TREE_FLAGS_INCLUDE_UNALLOCATED \
	MATEMENU_TREE_FLAGS_INCLUDE_UNALLOCATED
#define GMENU_TREE_FLAGS_SHOW_EMPTY        MATEMENU_TREE_FLAGS_SHOW_EMPTY
#define GMENU_TREE_FLAGS_SORT_DISPLAY_NAME MATEMENU_TREE_FLAGS_SORT_DISPLAY_NAME
